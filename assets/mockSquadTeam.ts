export const squadTeam: any [] = [
    { 
        name: "MR J", 
        info: `Fra di voi ci sarà sicuramente qualche appassionato de “La casa de Papel”… ecco Mister J
    ...
    { 
        name: "CHILY", 
        info: `Avete mai sentito parlare di un peperoncino rosso che gioca alle slots? Ebbene sì,
    ...
    { 
        name: "PITBULL", 
        info: `Attenti a non farmi arrabbiare perché … io sono Pitbull! Il mio nome deriva dal fatto che possiedo le
        caratteristiche dell’omonimo cane. La forza, insieme alla tenacia mi hanno permesso di ottenere un sacco di
    ...
    { 
        name: "VALUE", 
        info: `Salve a tutti, mi presento, sono Mr. Value e mi occupo di forniture di arredo scolastico ed
