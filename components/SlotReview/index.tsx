...
const SlotReview: FunctionComponent<Props> = ({ data, article }) => {
	console.log(article)
								...
								<Image
									...
									src={
										data.image && data.image.url
											? injectCDN(data.image.url)
											: `${CDN}/svg/no_img_available.svg`
									}
									layout='responsive'
									priority={true}
									sizes={'30vw'}
						...
						<Info>
							...
							<div className='row'>
								...
								<span>
									...
									{data.volatility === 'mediumHigh' &&
										'MEDIO-ALTA'}
									{data.volatility === 'medium' && 'MEDIA'}
									{data.volatility === 'mediumLow' &&
										'MEDIO-BASSO'}
...
const ImageComponent: FunctionComponent = (props: any) => {
	...
	return (
		<img
			...
			src={`https://wincasinoblogadmin.spikeapi.eu${props.src}`}
		/>
	)
}
