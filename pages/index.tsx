...
const IndexPage: FunctionComponent = () => (
  ...
  <Layout title="Home">
    ...
    <GridsContainer>
      <GridSlots label="Le slot da bar più famose." 
        row={3} 
        column={4} 
        xs={6} sm={4} md={4}/>
      <GridSlots label="Le slot VLT più divertenti." row={3} column={4} xs={6} sm={4} md={4}/>
    </GridsContainer>

    <GridsContainer>
      <GridSlots label="I top bonus dei casinò online in Italia."
        labelAlign={"center"}
        row={3} 
        column={1} 
        xs={12} sm={4} md={4}
...
const ImageContainer = styled.div`
  ...
  background-image: linear-gradient(-45deg, ${(props) => props.theme.colors.primary}, ${(props) => props.theme.colors.gradient});
  border-radius: 10px;
`
