					...
					<Intro>
						<div className='wrapper'>
							<MarkdownStyleProvider>
								<Markdown>{`# Monopoly Statistiche Live: Tutte le Estrazioni in Tempo Reale
...
**Gioca responsabilmente e solo se sei maggiorenne**.`}</Markdown>
							</MarkdownStyleProvider>
						</div>
						{/* <p>
							{t(
				...
				<Main>
					...
					<DiceRollContainer>
						<DiceRollTable
							type='low'
							data={tables.lowTierTable.rows}
						/>
						<DiceRollTable
							type='mid'
							data={tables.midTierTable.rows}
						/>
						<DiceRollTable
							type='high'
							data={tables.highTierTable.rows}
						/>
					</DiceRollContainer>
				</Main>
				...
				<Footer>
					<MarkdownStyleProvider>
						<Markdown>{`## Controlla gli ultimi numeri usciti al Monopoly Live
...
Divertiti con il meglio dei Game Show e ricorda che il gioco è vietato ai minori di 18 anni e può creare dipendenza patologica.`}</Markdown>
					</MarkdownStyleProvider>
					{/* <section>
						<h3>
							{t(
