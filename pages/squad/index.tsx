					...
					<Container>
						<Profile>
							...
							<div>
								...
								<p>
									...
									{t(
										'adoro i dadi e qualunque gioco li comprenda. '
									)}
									<br />
									{t(
										'Fra i miei giochi da casinò preferiti ci sono i live game Show come'
									)}{' '}
									<strong>{t('Monopoly Live')}</strong>{' '}
									{t('e Crazy Time. ')}
									{t(
									...
									<strong>{t('Lightning Dice')}</strong>.{' '}
									<br />
									<br />
									{t('La mia frase')}: “
									<strong>
										{t('Sono veramente egizio')}
									</strong>
									”{' '}
									{t(
										'è diventato celebre fra il pubblico di videogiocatori'
									)}
									{t(
						...
						<SocialNetwork>
							<a
								...
								href={
									'https://www.facebook.com/luckyilfortunato'
								}
							>
							...
							<a
								...
								rel='noopener noreferrer'
								href={
									'https://www.instagram.com/lucky_ilfortunato/'
								}
							>
						...
						<Profile>
							...
							<div>
								...
								<p>
									...
									{t(
										'della SG Gaming con il mitico Odino: chissà perché!'
									)}
									<br />
									{t(
										'Durante le sessioni di gioco alla slot online'
									)}{' '}
									<strong>Pillars of Asgard</strong>
									{t(' e alla slot digitale')}{' '}
									<strong>Rise of the Mountain King</strong>,
									{t(
										'ho ottenuto le vincite più gloriose in assoluto!'
									)}
									<br />
									{t(
									...
									“
									<strong>
										{t('Chi ha detto di uscire da qua')}
									</strong>
									”?
									{t(
					...
					<Container>
						<Profile>
							...
							<div>
								...
								<p>
									Tra tutti voi ci saranno sicuramente dei fan
									di “La Casa di Carta": beh, io sono il
									"Professor" della Squad.
									<br />
									In effetti, Mister J è importante per la
									Squad, così come il Professore è importante
									per Tokyo, Berlino, Rio etc,
									<br /> <br />
									e ci sono molte persone che mi considerano
									Charlie di "2 uomini e mezzo"!
									<br />
									<br />
									Nella mia vita mi occupo della gestione e
									della cura di ogni tipo di evento: dalle
									discoteche ai concerti. <br />
									Tuttavia, ovviamente, questo periodo è stato
									un po' complicato a causa della pandemia.
									<br />
									Possiedo vari e-commerce e ho lanciato
									diversi brand: dai prodotti per l'infanzia,
									ai ritratti realistici e stilizzati.
									<br />
									<br />
									Ogni tanto faccio live streaming e tornei di
									poker con i miei amici del canale inglese;{' '}
									<br />
									Mi piace passare del tempo con loro, così
									come con Pitbull e compagni, e adorano
									quando mi vesto da Capitan Canada o Batman
									perché è pura e sana "follia", <br />
									ed è ancora meglio se quei momenti sono
									accompagnati da temi televisivi e molte
									belle canzoni!
									<br />
									Direi che non ho proprio un gioco preferito,
									ma ricordo con piacere le mie vincite alla
									Big Bass Bonanza e al Crazy Time... <br />
									Di solito cerco di regalare un po' di
									divertimento ai nostri followers e a Chily
									il gufo durante i nostri Bonus Hunt!
									<br />
									<br />
									Anche se qualcuno ha qualcosa da dire sulle
									mie giocate, io risponderò con: "I’m Mister
									J, shhh". E non imitarmi, non farlo a casa!
								</p>
							</div>
						</Profile>
							...
							<div>
								<Thumbnail>
									<LazyLoad height={200} offset={200}>
										<Image
											alt={
												'Casino Squad Team | SQUAD PITBULL'
											}
								...
								<p>
									...
									<strong>Moon Princess</strong> di Play ‘n Go
									e altre.
									<br />
									<br />
									{t(
									...
									{t(
										'Durante le mie migliori vincite sentirete sempre:'
									)}{' '}
					...
					<Container>
						<Profile>
							...
							<div>
								...
								<p>
									...
									Yeeeeeaa... BOOM!!!! Mi chiamano Tony TNT
									per via della mia personalità esplosiva e
									dell'energia amplificata dal mio slogan
									"BOOM BAM!!!!" Che è energia sufficiente per
									potenziare tutti e fare boom!
									<br />
									Consiglio per il 2022: (Di' "BOOM BAM" non
									appena ti svegli per avere la massima
									energia per la giornata!)
									<br />
									<br />
									Essendo stato coinvolto nel mondo
									dell'intrattenimento e della creazione di
									contenuti per molti anni, amo lo streaming e
									il contatto con persone di tutto il mondo.{' '}
									<br />
									Mi piace rappare e fare musica ed è per
									questo che è stato creato il nome Tony TNT e
									potresti ottenere il freestyle se fai un
									salto in streaming!
									<br />
									In precedenza ero uno streamer su The Late
									Night Slots, Tony TNT era già conosciuto da
									Mr J ed è stato inserito nella Squad per
									aiutare a far saltare in aria il Canale
									Inglese! <br />
									<br />
									Presentato al resto della Squad nel mio
									ambiente naturale, una festa, Tony TNT ha
									suonato con la Squad e si è unito allo
									streaming di Live Casino Malta prima di
									unirsi ufficialmente alla Squad.
									<br />
									Uno dei miei giochi preferiti deve essere
									"Dead Mans Trail" poiché credo che abbia una
									delle funzioni bonus più interessanti.{' '}
									<br />
									Detiene una delle mie vincite più grandi che
									è di € 18,5k a 12300x. La mia vincita più
									grande alla slot va comunque a 'Evil
									Goblins', vincendo €20k a 20000x. <br />
									La mia vittoria più grande in assoluto va a
									"Crazy Time" dove ho ottenuto una vincita di
									2000 volte Pachinko € 50.000. Tutte queste
									vittorie e molte altre sono arrivate in un
									breve lasso di tempo, entro 2 mesi spero di
									vincerne molte altre qui con Casino Squad!
									<br />
									...BOOM!!!!
								</p>
							</div>
						...
						<SocialNetwork>
							<a
								...
								rel='noopener noreferrer'
								href={
									'https://www.instagram.com/tonytnt9/?utm_medium=copy_link'
								}
							>
								<InstagramIcon fontSize={'large'} />
							</a>
