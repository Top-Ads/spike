            ...
            <Profile>
              ...
              <div>
                ...
                <p>
                  ...
                  <strong>{t("Pillars of Asgard")}</strong> {t(
          ...
          <Container>
            <Profile>
              ...
              <div>
                ...
                <p>
                  Prepararsi per la detonazione.... Yeeeeeaa... BOOM!!!! Mi
                  chiamano Tony TNT per via della mia personalità esplosiva e
                  dell'energia amplificata dal mio slogan "BOOM BAM!!!!" Che è
                  energia sufficiente per potenziare tutti e fare boom!
                  <br />
                  Consiglio per il 2022: (Di' "BOOM BAM" non appena ti svegli
                  per avere la massima energia per la giornata!)
                  <br />
                  <br />
                  Essendo stato coinvolto nel mondo dell'intrattenimento e della
                  creazione di contenuti per molti anni, amo lo streaming e il
                  contatto con persone di tutto il mondo. <br />
                  Mi piace rappare e fare musica ed è per questo che è stato
                  creato il nome Tony TNT e potresti ottenere il freestyle se
                  fai un salto in streaming!
                  <br />
                  In precedenza ero uno streamer su The Late Night Slots, Tony
                  TNT era già conosciuto da Mr J ed è stato inserito nella Squad
                  per aiutare a far saltare in aria il Canale Inglese! <br />
                  <br />
                  Presentato al resto della Squad nel mio ambiente naturale, una
                  festa, Tony TNT ha suonato con la Squad e si è unito allo
                  streaming di Live Casino Malta prima di unirsi ufficialmente
                  alla Squad.
                  <br />
                  Uno dei miei giochi preferiti deve essere "Dead Mans Trail"
                  poiché credo che abbia una delle funzioni bonus più
                  interessanti. <br />
                  Detiene una delle mie vincite più grandi che è di € 18,5k a
                  12300x. La mia vincita più grande alla slot va comunque a
                  'Evil Goblins', vincendo €20k a 20000x. <br />
                  La mia vittoria più grande in assoluto va a "Crazy Time" dove
                  ho ottenuto una vincita di 2000 volte Pachinko € 50.000. Tutte
                  queste vittorie e molte altre sono arrivate in un breve lasso
                  di tempo, entro 2 mesi spero di vincerne molte altre qui con
                  Casino Squad!
                  <br />
                  ...BOOM!!!!
                </p>
            ...
            <SocialNetwork>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href={"https://www.instagram.com/tonytnt9/?utm_medium=copy_link"}
              >
                <InstagramIcon fontSize={"large"} />
              </a>
            </SocialNetwork>
