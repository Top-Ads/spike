...
const ProducerPage: FunctionComponent<PageProps> = ({producerData, slotsData}) => {
...
export async function getServerSideProps(context : NextPageContext) {
    ...
    return {
        props: {
            ...
            slotsData: await getSlots({countryCode: "it", limit: 24, start: 0, producer: slug, sort: 'updated_at:desc'})
        }
    }
}
